...
<h4>
O Hiring Coders é um programa de capacitação gratuito e sem pré-requisitos para ensinar programação.<br>
...
<h3 style="color: Cyan">Nós somos a equipe DreamScape </h3>
...
* [Administrativo da Loja (Gestão de Combinações)](#administrativo-da-loja-gestão-de-combinações-link---app-link---menu)
...
:small_blue_diamond: [Instruções de Uso](#-instruções-de-uso--)
* [Pré-Requisitos](#pré-requisitos)
* [Documentação de Uso](#documentação-de-uso)
  * [Sistema de Sugestões - Administrador](#sistema-de-sugestões---administrador)
  * [Sistema de Sugestões - Cliente](#sistema-de-sugestões---cliente)
...
### Resumo do Projeto
<p>
Sugestões Inteligentes é uma aplicação desenvolvida para disponibilizar, de forma automatizada, sugestões de itens combinados com base no perfil de vendas da loja, usando a regra de combinações mais vendidas.<br><br>
A aplicação conta com uma página administrativa que apresenta as sugestões para o lojista, onde ele pode gerenciá-las usando os menus de opções.<br><br>
...
### Administrativo da Loja (Gestão de Combinações) [(Link - App)](https://dreamscape.myvtex.com/admin/app/apps/dreamscape.dreamscape@0.1.11/setup) [(Link - Menu)](https://dreamscape.myvtex.com/admin/smart-suggestion)
